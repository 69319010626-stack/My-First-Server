// 1. เรียกใชงาน Module ที่ชื่อวา 'http' ซึ่งเปนระบบพื้นฐานของ Node.js สําหรับทําเซิรฟ เวอร
 ...
 res.end('<h1>สวัสดีครับ! นี่คือ Web Server ของ [ธาดา โพธิ์ชัย และ 69319010626] </h1><p>เครื่องแมขายทํางานปกติบนระบบ Railway แลวครับผม!</p>');
 });

 // 4. สั่งใหเซิรฟเวอรเริ่มตนเปดรับฟงการเชื่อมตอตาม Port ที่กําหนดไว
 server.listen(port, () => {
 console.log(`Server is running! เคร่อืงแมขายเปดทํางานแลวที่ชองทาง: ${port}`);
 });
